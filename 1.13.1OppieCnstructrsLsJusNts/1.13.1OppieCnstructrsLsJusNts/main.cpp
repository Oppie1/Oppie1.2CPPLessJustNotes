...
//Create a string variable that stores a name.
//CODE:

//Create an int variable that will hold an age.
//CODE:

//Create a variable that will store grade point average (decimal).
//CODE:
	 
//Declare a constructor with string, int and double as its parameter (a, b, c) which will set the values to variables
...
//Declare variables (attributes) that will store information from the constructor (year, make, model).
//CODE:
