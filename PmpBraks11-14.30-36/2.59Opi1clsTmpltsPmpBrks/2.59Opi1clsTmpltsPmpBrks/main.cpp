...
//Declare a constructor Adam with the parameters T a and T b and assign first and second member
...
//"T" (return type - like int,void, double, ect.) -> in "Adam" class -> using <T> (template) -> :: (access/run) -> member function 
//function "bigger() and return answer to the function to the caller (here main)"

//Define the function bigger() of template class T. Then the function of return type T OF Adam class and function..
//CODE:
